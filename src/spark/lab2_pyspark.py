...
def save_pipeline_results(transformed_df, start_time, end_time, fit_duration, transform_duration, vocab_duration, actual_vocab_size, search_results=None, search_duration=0, query_text=""):
    ...
    # 1. Lưu kết quả đầy đủ vào results/log3.txt    
    output_file = "results/log3.txt"
    print(f"Saving comprehensive results including input text and vector search to {output_file}...")
    
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("LAB 3 - Nguyen Thuy Trang - 22000128\n")
        f.write("=" * 80 + "\n\n")
        ...
        # User input và vector search results
    ...
    print(f"Comprehensive results with input text and vector search saved to: {output_file}")
...
def main():
    ...
    try:
        ...
        print("\n" + "=" * 80)
        print("LAB 3 PIPELINE WITH VECTOR SEARCH COMPLETED SUCCESSFULLY")
        print("=" * 80)
        ...
        print(f"   Results with input text and vector search: {output_file}")
